...
class IndirectAutoincrementArgument : public InstructionArgument {
	public:
		IndirectAutoincrementArgument(Memory *mem, Register *reg, bool bw);
		virtual ~IndirectAutoincrementArgument();
