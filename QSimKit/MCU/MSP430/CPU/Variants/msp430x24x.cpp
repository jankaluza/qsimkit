...
class Variant_msp430x24x : public Variant {
	public:
		Variant_msp430x24x() {}
		virtual ~Variant_msp430x24x() {}
		const char *getName() { return "msp430x24x"; }
...
MSP430_VARIANT("msp430x24x", msp430x24x);
